package VirtualGarden.Simulacion;
...
import VirtualGarden.utils.Observable;

public class ThreadSim extends Observable implements Runnable, Constantes {
	...
	public ThreadSim(StatusManager pManager) {
